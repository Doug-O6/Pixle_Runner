...
class Player(pygame.sprite.Sprite):
  ...
  def plyer_input(self):
    keys = pygame.key.get_pressed()
    if keys[pygame.K_SPACE] and self.rect.bottom >= 300:
      self.gravity = -20
      self.jump_sound.play()                       # Turn off sound here
      self.jump_sound.set_volume(0.2)              # volume 0 = no sound
...
def obstacle_movement(obstacle_list):
  ...
  if obstacle_list:
    for obstacle_rect in obstacle_list:
      ...
      if obstacle_rect.bottom == 300:            # Random choice between fly or snail
...
# Initiate pygame and setup basic items
pygame.init()
...
player_index = 0
player_jump = pygame.image.load('graphics/player/Astronaut_2.png').convert_alpha()
...
# Intro screen -----
player_stand = pygame.image.load('graphics/player/Astronaut_1.png').convert_alpha()
